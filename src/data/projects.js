...
import anglerMain from '../assets/projects/angler/angler.png';
...
export const projects = [
  { key: 'vilaistra',  slug: 'vila-istra',            category: 'web',      video: vilaIstraVideo,   gallery: [] },
  { key: 'patrickboy', slug: 'patrick-boy-transferi', category: 'web',      video: patrickBoyVideo,  gallery: [] },
  { key: 'apartmani',  slug: 'apartmani-cres',        category: 'web',      gallery: [apartmaniImg], tall: true },
  { key: 'houselucy',  slug: 'house-lucy-razanac',    category: 'web',      gallery: [houseLucyImg], tall: true },
  { key: 'otooles',    slug: 'pansion-otooles',       category: 'web',      gallery: [otoolesImg],   tall: true },
  { key: 'flexportal', slug: 'flexportal',            category: 'software', gallery: [flexportalImg], logo: sympowerLogo },
  { key: 'timetable',  slug: 'sustav-javni-prijevoz', category: 'software', gallery: [timetableImg],  logo: atronLogo, mono: true },
  { key: 'angler',     slug: 'angler',                category: 'mobile',   gallery: [anglerMain, anglerSS0, anglerSS1, anglerSS3, anglerSS4] },
  { key: 'bonfon',     slug: 'bonfon',                category: 'mobile',   gallery: [bonfonImg] },
  { key: 'thesis',     slug: 'senzorske-mreze',       category: 'software', gallery: [sensorNetworkImg], mono: true },
  { key: 'smarthome',  slug: 'smart-home',            category: 'mobile',   gallery: [smarthomeImg] },
];
